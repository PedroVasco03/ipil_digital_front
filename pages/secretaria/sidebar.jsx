    ...
    return(
        ...
        <nav className={styleSide.side+" "+styleGeral.side}>
                    <ul className={styleSide.ul}>
                        <li className={styleSide.li}><a href="/secretaria/homesecretaria" className={styleSide.a}> 
                            <Image className={styleSide.i} src={init} alt='inicio'/>
                            <span className={styleSide.side_item+" "+styleSide.span}>Início</span>
                        </a></li>
                        <li className={styleSide.li}><a href="/secretaria/chatsecretaria" className={styleSide.a}>
                            <Image className={styleSide.i} src={chat} alt='Chat'/>
                            <span className={styleSide.side_item+" "+styleSide.span}>Chat</span>
                        </a></li>
                        <li className={styleSide.li}><a href="/secretaria/teamsecretaria" className={styleSide.a}>
                            <Image className={styleSide.i} src={coord} alt='Secretaria'/>
                            <span className={styleSide.side_item+" "+styleSide.span}>Secretaria</span>
                        </a></li>
                        <li className={styleSide.li}><a href="/secretaria/settingsecretaria" className={styleSide.a}>
